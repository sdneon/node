...
// Set up methods on the process object for all threads
{
  ...
  //SD: Quick hack: allow REPL time to 'close' properly before running new main script which may need readline
  //    O.w. the script may terminate unexpectedly
  process.__RUN_MAIN_DELAY_MS__ = 200;
  process.runMain = function(...args)
  {
    if (typeof process.closeRepl === 'function')
    {
       process.closeRepl();
    }
    setTimeout(() => process._runMain(...args), process.__RUN_MAIN_DELAY_MS__);
  };
}
