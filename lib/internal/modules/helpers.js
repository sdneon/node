...
//SD: Allow registration of bundled modules
if (!global._cachePackedMods)
{
  global._cachePackedMods = {};
  function registerPackedModule(path, mod)
  {
    global._cachePackedMods[path] = mod;
  }
  global.registerPackedModule = registerPackedModule;
}
